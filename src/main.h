...
static const int LAST_POW_BLOCK = 5000000000; //about 10,000 Years of PoW blocks
...
static const int64_t MAX_MONEY = 1888000000 * COIN;
...
static const uint256 hashGenesisBlock("0x000002f147ed392ad7d552bbfc4fa0ad3e0b15d386dae372a78344ed1b32a0d4");
static const uint256 hashGenesisBlockTestNet("0x000002f147ed392ad7d552bbfc4fa0ad3e0b15d386dae372a78344ed1b32a0d4");
...
public:
    ...
    {
        // WithCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // WithCoin: get transaction coin age
...
public:
    ...
    // WithCoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // WithCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // WithCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // WithCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // WithCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // WithCoin: block index flags
    enum  
    {
